...
```html
 ...
 - 全局导入
 ```html
    import ZzcUI from 'zzc-ui'
    import 'zzc-ui/lib/zzc-ui.css'
...
```html
<template>
  <div class="zzc-dialog__wrapper">
    <div class="zzc-dialog">
      <div class="zzc-dialog__header">
        <span class="zzc-dialog__title">提示</span>
        <button class="zzc-dialog__headerbtn">
      ...
      <div class="zzc-dialog__footer">
        <zzc-button>取消</zzc-button>
        <zzc-button type="primary">确定</zzc-button>
      </div>
    </div>
  </div>
</template>
...
<script>
import zzcButton from '../../button/index'
export default {
  name: 'zzcDialog',
  components: {
    zzcButton
...
<template>
  <div class="zzc-input">
    <input type="text" class="zzc-input__inner">
  </div>
</template>
```
...
```html
<input type="text" class="zzc-input__inner" :placeholder="placeholder">
```
...
```js
<zzc-input placeholder="请输入用户名" v-model="username"></zzc-input><br>
```
...
```html
<template>
  <label class="zzc-checkbox">
    <span class="zzc-checkbox__input">
      <span class="zzc-checkbox__inner"></span>
      <input type="checkbox" class="zzc-checkbox__original">
    </span>
    <span class="zzc-checkbox__label" v-if="$slots.default">
      <slot></slot>
    </span>
  </label>
...
```html
<template>
  <div class="zzc-switch" @click="handleChange" :class="{ 'is-checked': this.value }">
    <span class="zzc-switch__core" ref="core">
      <span class="zzc-switch__button" :style="style"></span>
    </span>
  </div>
</template>
```
